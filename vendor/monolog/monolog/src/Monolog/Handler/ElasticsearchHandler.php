 ...
 */
namespace AZO\Monolog\Handler;

use AZO\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use AZO\Monolog\Logger;
use AZO\Monolog\Formatter\FormatterInterface;
use AZO\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use AZO\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use AZO\Elasticsearch\Client;
use AZO\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use AZO\Elastic\Elasticsearch\Client as Client8;
/**
