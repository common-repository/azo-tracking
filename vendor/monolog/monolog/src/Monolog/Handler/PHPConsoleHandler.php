...
use AZO\Monolog\Formatter\LineFormatter;
use AZO\Monolog\Formatter\FormatterInterface;
use AZO\Monolog\Logger;
use AZO\Monolog\Utils;
use AZO\PhpConsole\Connector;
use AZO\PhpConsole\Handler as VendorPhpConsoleHandler;
use AZO\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('AZO\\PhpConsole\\Connector')) {
