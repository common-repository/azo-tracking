...
use AZO\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use AZO\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use AZO\Monolog\Logger;
use AZO\Monolog\ResettableInterface;
