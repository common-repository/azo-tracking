...
use AZO\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use AZO\GuzzleHttp\Promise\Promise;
use AZO\GuzzleHttp\Promise\RejectedPromise;
use AZO\GuzzleHttp\Psr7\Response;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('AZO\\GuzzleHttp\\Promise\\Promise')) {
