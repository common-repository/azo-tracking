...
class Experiment extends \Google\Collection
{
    ...
    protected $parentLinkType = \Google\Service\Analytics\ExperimentParentLink::class;
     ...
     */
    public $updated;
    protected $variationsType = \Google\Service\Analytics\ExperimentVariations::class;
...
\class_alias(\Google\Service\Analytics\Experiment::class, 'AZO\\Google_Service_Analytics_Experiment');
