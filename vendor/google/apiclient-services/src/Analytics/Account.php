...
{
    protected $childLinkType = \Google\Service\Analytics\AccountChildLink::class;
     ...
     */
    public $name;
    protected $permissionsType = \Google\Service\Analytics\AccountPermissions::class;
...
\class_alias(\Google\Service\Analytics\Account::class, 'AZO\\Google_Service_Analytics_Account');
