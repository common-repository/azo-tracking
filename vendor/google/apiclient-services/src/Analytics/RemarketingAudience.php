...
class RemarketingAudience extends \Google\Collection
{
     ...
     */
    public $accountId;
    protected $audienceDefinitionType = \Google\Service\Analytics\RemarketingAudienceAudienceDefinition::class;
     ...
     */
    public $kind;
    protected $linkedAdAccountsType = \Google\Service\Analytics\LinkedForeignAccount::class;
     ...
     */
    public $name;
    protected $stateBasedAudienceDefinitionType = \Google\Service\Analytics\RemarketingAudienceStateBasedAudienceDefinition::class;
     ...
     */
    public function setAudienceDefinition(\Google\Service\Analytics\RemarketingAudienceAudienceDefinition $audienceDefinition)
    {
     ...
     */
    public function setStateBasedAudienceDefinition(\Google\Service\Analytics\RemarketingAudienceStateBasedAudienceDefinition $stateBasedAudienceDefinition)
    {
...
\class_alias(\Google\Service\Analytics\RemarketingAudience::class, 'AZO\\Google_Service_Analytics_RemarketingAudience');
