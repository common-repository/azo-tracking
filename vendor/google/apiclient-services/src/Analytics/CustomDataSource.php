...
class CustomDataSource extends \Google\Collection
{
     ...
     */
    public $accountId;
    protected $childLinkType = \Google\Service\Analytics\CustomDataSourceChildLink::class;
     ...
     */
    public $name;
    protected $parentLinkType = \Google\Service\Analytics\CustomDataSourceParentLink::class;
...
\class_alias(\Google\Service\Analytics\CustomDataSource::class, 'AZO\\Google_Service_Analytics_CustomDataSource');
