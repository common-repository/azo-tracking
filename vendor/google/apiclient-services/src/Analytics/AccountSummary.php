...
class AccountSummary extends \Google\Collection
{
     ...
     */
    public $starred;
    protected $webPropertiesType = \Google\Service\Analytics\WebPropertySummary::class;
...
\class_alias(\Google\Service\Analytics\AccountSummary::class, 'AZO\\Google_Service_Analytics_AccountSummary');
