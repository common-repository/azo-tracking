...
class Webproperty extends \Google\Model
{
     ...
     */
    public $accountId;
    protected $childLinkType = \Google\Service\Analytics\WebpropertyChildLink::class;
     ...
     */
    public $name;
    protected $parentLinkType = \Google\Service\Analytics\WebpropertyParentLink::class;
    protected $parentLinkDataType = '';
    public $parentLink;
    protected $permissionsType = \Google\Service\Analytics\WebpropertyPermissions::class;
...
\class_alias(\Google\Service\Analytics\Webproperty::class, 'AZO\\Google_Service_Analytics_Webproperty');
