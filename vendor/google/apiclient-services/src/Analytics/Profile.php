...
class Profile extends \Google\Model
{
    ...
    protected $childLinkType = \Google\Service\Analytics\ProfileChildLink::class;
     ...
     */
    public $name;
    protected $parentLinkType = \Google\Service\Analytics\ProfileParentLink::class;
    protected $parentLinkDataType = '';
    public $parentLink;
    protected $permissionsType = \Google\Service\Analytics\ProfilePermissions::class;
...
\class_alias(\Google\Service\Analytics\Profile::class, 'AZO\\Google_Service_Analytics_Profile');
