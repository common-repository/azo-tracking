...
class UnsampledReport extends \Google\Model
{
     ...
     */
    public $accountId;
    protected $cloudStorageDownloadDetailsType = \Google\Service\Analytics\UnsampledReportCloudStorageDownloadDetails::class;
     ...
     */
    public $downloadType;
    protected $driveDownloadDetailsType = \Google\Service\Analytics\UnsampledReportDriveDownloadDetails::class;
     ...
     */
    public function setCloudStorageDownloadDetails(\Google\Service\Analytics\UnsampledReportCloudStorageDownloadDetails $cloudStorageDownloadDetails)
    {
     ...
     */
    public function setDriveDownloadDetails(\Google\Service\Analytics\UnsampledReportDriveDownloadDetails $driveDownloadDetails)
    {
...
\class_alias(\Google\Service\Analytics\UnsampledReport::class, 'AZO\\Google_Service_Analytics_UnsampledReport');
