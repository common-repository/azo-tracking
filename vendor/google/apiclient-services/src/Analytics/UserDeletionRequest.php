...
class UserDeletionRequest extends \Google\Model
{
    ...
    protected $idType = \Google\Service\Analytics\UserDeletionRequestId::class;
     ...
     */
    public function setId(\Google\Service\Analytics\UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
...
\class_alias(\Google\Service\Analytics\UserDeletionRequest::class, 'AZO\\Google_Service_Analytics_UserDeletionRequest');
