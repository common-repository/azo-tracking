...
class GaData extends \Google\Collection
{
    ...
    protected $columnHeadersType = \Google\Service\Analytics\GaDataColumnHeaders::class;
    ...
    protected $dataTableType = \Google\Service\Analytics\GaDataDataTable::class;
     ...
     */
    public $previousLink;
    protected $profileInfoType = \Google\Service\Analytics\GaDataProfileInfo::class;
    protected $profileInfoDataType = '';
    public $profileInfo;
    protected $queryType = \Google\Service\Analytics\GaDataQuery::class;
...
\class_alias(\Google\Service\Analytics\GaData::class, 'AZO\\Google_Service_Analytics_GaData');
