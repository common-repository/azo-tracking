...
class WmxSitemap extends \Google\Collection
{
    ...
    protected $contentsType = \Google\Service\SearchConsole\WmxSitemapContent::class;
...
\class_alias(\Google\Service\SearchConsole\WmxSitemap::class, 'AZO\\Google_Service_SearchConsole_WmxSitemap');
