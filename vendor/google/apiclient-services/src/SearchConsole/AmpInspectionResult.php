...
class AmpInspectionResult extends \Google\Collection
{
    ...
    protected $issuesType = \Google\Service\SearchConsole\AmpIssue::class;
...
\class_alias(\Google\Service\SearchConsole\AmpInspectionResult::class, 'AZO\\Google_Service_SearchConsole_AmpInspectionResult');
