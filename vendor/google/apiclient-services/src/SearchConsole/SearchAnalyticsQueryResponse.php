...
class SearchAnalyticsQueryResponse extends \Google\Collection
{
    ...
    protected $rowsType = \Google\Service\SearchConsole\ApiDataRow::class;
...
\class_alias(\Google\Service\SearchConsole\SearchAnalyticsQueryResponse::class, 'AZO\\Google_Service_SearchConsole_SearchAnalyticsQueryResponse');
