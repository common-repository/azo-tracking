...
class SearchAnalyticsQueryRequest extends \Google\Collection
{
     ...
     */
    public $dataState;
    protected $dimensionFilterGroupsType = \Google\Service\SearchConsole\ApiDimensionFilterGroup::class;
...
\class_alias(\Google\Service\SearchConsole\SearchAnalyticsQueryRequest::class, 'AZO\\Google_Service_SearchConsole_SearchAnalyticsQueryRequest');
