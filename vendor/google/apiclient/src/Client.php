...
use AZO\GuzzleHttp\Client as GuzzleClient;
use AZO\GuzzleHttp\ClientInterface;
use AZO\GuzzleHttp\Ring\Client\StreamHandler;
use AZO\Psr\Cache\CacheItemPoolInterface;
use AZO\Psr\Http\Message\RequestInterface;
use AZO\Psr\Log\LoggerInterface;
use AZO\Monolog\Logger;
use AZO\Monolog\Handler\StreamHandler as MonologStreamHandler;
use AZO\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('AZO\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('AZO\\GuzzleHttp\\ClientInterface::VERSION')) {
