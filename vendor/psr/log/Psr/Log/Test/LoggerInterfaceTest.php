...
namespace AZO\Psr\Log\Test;

use AZO\Psr\Log\LoggerInterface;
use AZO\Psr\Log\LogLevel;
use AZO\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('AZO\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('AZO\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('AZO\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
