...
namespace AZO\GuzzleHttp;

use AZO\GuzzleHttp\Cookie\CookieJar;
use AZO\GuzzleHttp\Exception\GuzzleException;
use AZO\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \AZO\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
