...
namespace AZO\GuzzleHttp\Exception;

use AZO\GuzzleHttp\BodySummarizer;
use AZO\GuzzleHttp\BodySummarizerInterface;
use AZO\Psr\Http\Client\RequestExceptionInterface;
