 ...
 */
namespace AZO\phpseclib3\Crypt\EC\BaseCurves;

use AZO\phpseclib3\Common\Functions\Strings;
use AZO\phpseclib3\Math\BigInteger;
use AZO\phpseclib3\Math\Common\FiniteField\Integer;
use AZO\phpseclib3\Math\PrimeField;
use AZO\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
