 ...
 */
namespace AZO\phpseclib3\Common\Functions;

use AZO\ParagonIE\ConstantTime\Base64;
use AZO\ParagonIE\ConstantTime\Base64UrlSafe;
use AZO\ParagonIE\ConstantTime\Hex;
use AZO\phpseclib3\Math\BigInteger;
use AZO\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
