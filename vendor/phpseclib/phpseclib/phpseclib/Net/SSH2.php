 ...
 */
namespace AZO\phpseclib3\Net;

use AZO\phpseclib3\Common\Functions\Strings;
use AZO\phpseclib3\Crypt\Blowfish;
use AZO\phpseclib3\Crypt\ChaCha20;
use AZO\phpseclib3\Crypt\Common\AsymmetricKey;
use AZO\phpseclib3\Crypt\Common\PrivateKey;
use AZO\phpseclib3\Crypt\Common\PublicKey;
use AZO\phpseclib3\Crypt\Common\SymmetricKey;
use AZO\phpseclib3\Crypt\DH;
use AZO\phpseclib3\Crypt\DSA;
use AZO\phpseclib3\Crypt\EC;
use AZO\phpseclib3\Crypt\Hash;
use AZO\phpseclib3\Crypt\Random;
use AZO\phpseclib3\Crypt\RC4;
use AZO\phpseclib3\Crypt\Rijndael;
use AZO\phpseclib3\Crypt\RSA;
use AZO\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use AZO\phpseclib3\Crypt\Twofish;
use AZO\phpseclib3\Exception\ConnectionClosedException;
use AZO\phpseclib3\Exception\InsufficientSetupException;
use AZO\phpseclib3\Exception\NoSupportedAlgorithmsException;
use AZO\phpseclib3\Exception\UnableToConnectException;
use AZO\phpseclib3\Exception\UnsupportedAlgorithmException;
use AZO\phpseclib3\Exception\UnsupportedCurveException;
use AZO\phpseclib3\Math\BigInteger;
use AZO\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
    ...
    public function exec($command, callable $callback = null)
    {
        ...
        $packet_size = 0x4000;
        $packet = Strings::packSSH2('CsN3', NET_SSH2_MSG_CHANNEL_OPEN, 'session', self::CHANNEL_EXEC, $this->window_size_server_to_client[self::CHANNEL_EXEC], $packet_size);
        $this->send_binary_packet($packet);
    ...
    private function initShell()
    {
        ...
        $packet_size = 0x4000;
        $packet = Strings::packSSH2('CsN3', NET_SSH2_MSG_CHANNEL_OPEN, 'session', self::CHANNEL_SHELL, $this->window_size_server_to_client[self::CHANNEL_SHELL], $packet_size);
        $this->send_binary_packet($packet);
    ...
    public function startSubsystem($subsystem)
    {
        ...
        $packet = Strings::packSSH2('CsN3', NET_SSH2_MSG_CHANNEL_OPEN, 'session', self::CHANNEL_SUBSYSTEM, $this->window_size, 0x4000);
        $this->send_binary_packet($packet);
    ...
    public function ping()
    {
        ...
        $packet_size = 0x4000;
        $packet = Strings::packSSH2('CsN3', NET_SSH2_MSG_CHANNEL_OPEN, 'session', self::CHANNEL_KEEP_ALIVE, $this->window_size_server_to_client[self::CHANNEL_KEEP_ALIVE], $packet_size);
        try {
            $this->send_binary_packet($packet);
        ...
        while (\true) {
            ...
            if (isset($channel) && isset($this->channel_status[$channel]) && isset($this->window_size_server_to_client[$channel])) {
                ...
                switch ($this->channel_status[$channel]) {
                    ...
                    case NET_SSH2_MSG_CHANNEL_CLOSE:
                        return $type == NET_SSH2_MSG_CHANNEL_CLOSE ? \true : $this->get_channel_packet($client_channel, $skip_extended);
                }
            }
